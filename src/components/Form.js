  ...
  async sendEmail(e) {
    ...
    try {
      ...
      if (window.innerWidth < 576) {
        this.setState({
          button: { label: "Picked It Up", obfuscate: true, update: true },
        });
      } else {
        this.setState({
          firstLine: "Picked It",
      ...
      if (window.innerWidth < 576) {
        this.setState((state) => ({
          button: { ...state.button, obfuscate: false },
        }));
      }
    }
  }
      ...
      <div className="container">
        ...
        <div className="speech">
          <h2 className="title title--contact">
            ...
            <br />
            <span ref={this.dash} className="dash"></span>
            <Baffle
              speed={100}
              characters={characters}
              obfuscate={activeSection === 2 ? obfuscate : false}
          ...
          <p className="subtitle">
            It is very important for me to keep in touch with you, so I am
            always ready to answer any question that interests you.
            <span className="highlighted" data-stroke="&nbsp;Shoot!">
              &nbsp;Shoot!
            </span>
          </p>
        </div>
